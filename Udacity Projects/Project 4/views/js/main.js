...
//The following code was adjusted to Project 4 purposes:
//changePizzasize was optimized and streamlined so the size of the pizzas would change under 2 ms (not over 100 ms)
//UpdatePosition was optimized by eliminating excessive number of pizzas along with streamlining code to calculate position
...
var resizePizzas = function(size) {
    ...
    //Adjust the pizza sizes to small, medium, or laarge
    function changePizzaSizes(size) {
        ...
        for (var i = 0, rPLength = document.getElementsByClassName("randomPizzaContainer").length; i < rPLength; i++) {
...
function updatePositions() {
    ...
    var scrollposs = document.body.scrollTop;
    var items = document.querySelectorAll('.mover');


    var phase;
    for (var i = 0, itemsLength = items.length; i < itemsLength; i++) {
        phase = Math.sin((scrollposs / 1250) + (i % 5));
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var s = 256;
    var elem;
    var MP = document.getElementById("movingPizzas1")
    for (var i = 0; i < 48; i++) {
